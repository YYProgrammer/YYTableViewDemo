...
@implementation YYHighPerDataManager
...
+ (void)getCarListDataWithBlock:(void(^)(NSArray *dataArray, NSError *error))block
{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        NSArray *dataArray = [NSArray modelArrayWithClass:[YYHighPerCarModel class] json:jsonDict[@"data"]];
        for (YYHighPerCarModel *model in dataArray)
        {
